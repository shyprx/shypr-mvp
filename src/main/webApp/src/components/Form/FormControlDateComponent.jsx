...
export default class FormControlDateComponent extends React.Component {
      ...
      <Fragment>
        ...
        <div className={fieldContainerClassName}>
          {/* {this.props.isMobile ?
            ...
            {fieldChild}
            <a className="input-group-addon" href="javascript:;">
 ...
 * @type {Object}
 */
FormControlDateComponent.propTypes = {
...
FormControlDateComponent.defaultProps={
  isMobile: false,
}
