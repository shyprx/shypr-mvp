...
export default class DatatableComponent extends Component {
  ...
  onPageChange(data) {
    ...
    this.setState({...this.state, currentPage: selectedPage}, () => {
      if(this.props.remote) {
        this.props.onChange(selectedPage, pageSize, sortCol, sortDir)
      }
    })
  }
  ...
  renderPagination() {
    ...
    const pageCount = Math.ceil(this.state.total / pageSize)
  ...
  initColumnMetadata() {
    ...
    this.setState({...this.state, key: keyCell})
    return columns
  }
  ...
  handleSort(col) {
    if(!this.props.loading) {
      ...
      this.setState({...this.state, currentPage: 0, sortCol: col, sortDir: dir}, () => {
  ...
  render() {
    ...
    const { pageSize, loading, indexable } = this.props
    const { key, currentPage, sortCol, sortDir, total } = this.state
